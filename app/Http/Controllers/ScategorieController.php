...
class ScategorieController extends Controller
{
    ...
    public function index()
    {
        try 
        {
            $scategories=Scategorie::with('categorie')->get(); // Inclut la catégorie liée par with jointure avec categorie par with; 
    ...
    public function store(Request $request)
    {
        try 
        {
            $scategorie=new Scategorie([ "nomscategorie"=>$request->input("nomscategorie"), 
            "imagescategorie"=>$request->input("imagescategorie"), 
            "categorieID"=>$request->input("categorieID") ]);
            $scategorie->save(); return response()->json($scategorie); 
        }
        catch (\Exception $e) 
        {
    ...
    public function destroy(Scategorie $scategorie)
    {
        ...
        {
            $scategorie=Scategorie::findOrFail($id); 
            $scategorie->delete(); return response()->json("Sous catégorie supprimée avec succes"); 
        }
        catch (\Exception $e) 
        {
